...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
       const maxSupply = 1000000n;  // Total supply (1 million tokens)
       const decimals = 8;          // Like Bitcoin (8 decimal places)
       const name = "MyFirstToken"; // Your token's name
       const symbol = "MFT";       // 3-4 letter symbol
